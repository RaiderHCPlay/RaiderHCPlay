...
<div class="text-(--text)">
  <a
    ...
    target="_blank"
    class="flex justify-center items-center flex-col sm:flex-row mt-10"
  >
    <svg
      width="40px"
      height="40px"
    ...
    {#if spotify?.error || !spotify?.isPlaying}
      <h1 class="ml-3.75">Nothing playing right now</h1>
    {:else if spotify?.isPlaying}
      <img
        ...
        height="60"
      />
      <div class="mt-2.5 ml-0 sm:ml-3.75 sm:mt-0 flex items-center flex-col">
