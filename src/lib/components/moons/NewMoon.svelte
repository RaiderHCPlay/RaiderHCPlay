...
>
  ...
  <g id="SVGRepo_iconCarrier">
    <circle cx="64" cy="64" r="60" fill="#05070b"></circle>

    <path
      d="M64.01 8.91c-.07 1.36-3.5 2.08-7.48 2.28c-3.99.2-7.29-.2-7.59-1.53c-.29-1.32 2.83-3.14 7.19-3.37s7.96 1.26 7.88 2.62z"
      fill="var(--surface0)"
    ></path>
