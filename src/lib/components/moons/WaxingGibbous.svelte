...
>
  ...
  <g id="SVGRepo_iconCarrier">
    <path
      d="M64 4s-35.92 7.23-35.92 59.22C28.08 114.75 64 124 64 124c33.14 0 60-26.86 60-60S97.14 4 64 4z"
      fill="var(--accent2)"
    ></path>
    <path
      d="M30.53 64C30.53 17.04 64 4 64 4C30.86 4 4 30.86 4 64s26.86 60 60 60c0 0-33.47-13.04-33.47-60z"
      fill="var(--black)"
    ></path>
    <path
      d="M56.53 11.19c3.99-.2 7.41-.92 7.48-2.28c.06-1-1.9-2.08-4.68-2.48c-1.86 1.12-4.13 2.68-6.59 4.73c1.12.09 2.41.1 3.79.03z"
      fill="var(--accent)"
    ></path>
    <path
      d="M56.13 6.29c-4.36.23-7.48 2.05-7.19 3.37c.19.87 1.68 1.34 3.8 1.5c2.46-2.06 4.74-3.61 6.59-4.73c-.98-.14-2.06-.2-3.2-.14z"
      fill="var(--surface0)"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M26.26 102.61c-1.02-.95-1.91-.73-2.01-.57c-1.15 1.68 1.47 6.44 6.28 7.28c1 .17 2.17-.75.97-1.83c-1.21-1.09-4.22-3.93-5.24-4.88z"
      fill="var(--surface0)"
    ></path>
    <path
      d="M42.04 114.42c-.48 1.98 3.66 5.49 8.46 4.57c1-.19 1.76-1.47.25-2.06c-1.51-.59-5.33-2.17-6.63-2.7s-2.04 0-2.08.19z"
      fill="var(--surface0)"
    ></path>
    <path
      d="M49.23 112.75c.28-.71-.33-1.45-.93-1.91c-.5-.39-1.87-1.25-3.51-2.13c1.33 1.66 2.68 3.17 4.02 4.52c.18-.12.34-.26.42-.48z"
      fill="var(--accent)"
    ></path>
    <path
      d="M36.36 106.86c-.52 1.99 3.15 4.36 4.55 5.13c1.99 1.09 4.27 1.67 6.55 1.6c.46-.01.98-.11 1.35-.36a58.963 58.963 0 0 1-4.02-4.52c-3.39-1.83-7.93-3.76-8.43-1.85z"
      fill="var(--surface0)"
    ></path>
    <path
