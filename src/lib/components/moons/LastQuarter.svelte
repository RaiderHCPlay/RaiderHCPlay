...
>
  ...
  <g id="SVGRepo_iconCarrier">
    <path
      d="M4 64c0 33.14 26.86 60 60 60c0 0 2.94-18.45 2.96-60.41S64 4 64 4C30.86 4 4 30.86 4 64z"
      fill="var(--accent2)"
    ></path>
    <path d="M124 64c0-33.14-26.86-60-60-60v120c33.14 0 60-26.86 60-60z" fill="var(--black)"></path>
    <path
    ...
    ></path>
    <path
      d="M111.64 85.22c-.62 1.56-2.29 5.51-2.85 6.84c-.56 1.34.01 2.08.21 2.12c2.12.43 5.87-3.9 4.84-8.77c-.2-1-1.58-1.75-2.2-.19z"
      fill="var(--surface0)"
    ></path>
    <path
