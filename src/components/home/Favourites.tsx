          ...
          <h3>
            <svg width="40px" height="40px" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#7366d3" viewBox="0 0 24 24">
              ...
              <g id="SVGRepo_iconCarrier">
                {" "}
                <path d="M6 12H10M8 10V14M15 13H15.01M18 11H18.01M5.2 18H18.8C19.9201 18 20.4802 18 20.908 17.782C21.2843 17.5903 21.5903 17.2843 21.782 16.908C22 16.4802 22 15.9201 22 14.8V9.2C22 8.0799 22 7.51984 21.782 7.09202C21.5903 6.71569 21.2843 6.40973 20.908 6.21799C20.4802 6 19.9201 6 18.8 6H5.2C4.07989 6 3.51984 6 3.09202 6.21799C2.71569 6.40973 2.40973 6.71569 2.21799 7.09202C2 7.51984 2 8.07989 2 9.2V14.8C2 15.9201 2 16.4802 2.21799 16.908C2.40973 17.2843 2.71569 17.5903 3.09202 17.782C3.51984 18 4.0799 18 5.2 18Z" stroke="#7366d3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>{" "}
              </g>
            </svg>
            Games
          </h3>
